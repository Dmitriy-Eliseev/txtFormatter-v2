...
/* Suppress pedantic warnings for function pointer / void* conversions.
 * This is intentional design in tinyexpr and safe on all modern platforms. */
...
static double fac(double a) {/* simplest version of fac */
    if (a < 0.0)
        return NAN;
    /* Practical limit: 170! is the largest factorial that fits in double.
     * Also prevents DoS from huge inputs looping billions of times. */
    if (a > 170.0)
        return INFINITY;
